...
const EmptyFilterDetail = (props) => {
    return (
        <Container>
            <TitleMark />
            <P>CIFilter.io is an <A href="https://github.com/noahsark769/cifilter.io">open source</A> <A href="https://developer.apple.com/documentation/coreimage/cifilter">CIFilter</A> documentation project. It has two parts:</P>
            <OL>
            ...
            <P>To learn more about CIFilter.io, check out this <A href="https://noahgilmore.com/blog/cifilterio/">blog post</A>.</P>
